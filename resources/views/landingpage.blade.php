                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <img class="rounded img-fluid" src="{{ asset('img/foto-abimanyu.jpeg') }}" alt="avatar"
                                style="width: 150px">
                            <h5 class="my-3">Abimanyu Okysaputra Rachman</h5>
                            <p class="text-muted mb-1">Full Stack Developer</p>
                            <p class="text-muted mb-4">Kota Depok, Jawa Barat</p>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-0">
                            <ul class="list-group list-group-flush rounded-3">
                                <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                    ...
                                    <p class="mb-0">kyriten</p>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                    <i class="fab fa-instagram fa-lg" style="color: #ac2bac;"></i>
                                    <p class="mb-0">ossastra</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">Abimanyu Okysaputra Rachman</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">okysaputraa10@gmail.com</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">(+62) 812-9479-7215</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">Kota Depok, Jawa Barat</p>
                                </div>
                            </div>
                        </div>
                    </div>
